...
function RadioGroupItem({
  ...
  return (
    ...
    >
      ...
      >
        <CircleIcon className="fill-white absolute top-1/2 left-1/2 clamp-[size,3,4,@sm,@lg] -translate-x-1/2 -translate-y-1/2 stroke-0" />
      </RadioGroupPrimitive.Indicator>
    </RadioGroupPrimitive.Item>
  );
}
